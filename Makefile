...
.PHONY: check compile lint test validate demo plan m1-validate m1-demo m15-demo m2-demo experiment-verify-demo paper-demo paper-audit-demo vectorbt-test vectorbt-demo rqalpha-test rqalpha-demo
